...
<div class="container">
    ...
    <div class="mb-3">
        <a href="{{ route('pemasukan.create') }}" class="btn btn-primary-i">
            <i class="bi bi-plus"> Pemasukan</i>
        </a>
    </div>
    ...
    <div class="col-lg-12 col-md-12 mb-4 custom-width-i">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <table id="tabelPemasukan" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Tanggal</th>
                    ...
                    <tbody>
                        @forelse ($pemasukan as $item)
                            <tr>
                                ...
                                <td>{{ $item->sumberPemasukan->nama ?? '-' }}</td>
                                <td>
